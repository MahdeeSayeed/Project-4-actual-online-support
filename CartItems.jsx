...
const CartItems = ({ imgSRC, title, price, subtotal, id, quan }) => {
  ...
  // console.log("Cart item:", { title, price, quan, id });
  ...
  return (
    <>
      ...
      <Flex className="justify-between py-6 px-10 shadow-sm mt-10   ">
        <div className=" flex justify-between">
          <span
            ...
            className="w-4 h-4 rounded-full bg-red-500 text-white text-xs flex justify-center items-center cursor-pointer"
          >
            X
          </span>
          ...
          <div>
            <h2>
              <span>{title ? `${title.slice(0, 10)}...` : ""}</span>
              {price}
            </h2>
          </div>
          <div>
        ...
        <div className="mr-39">
          ...
          <h2>${((Number(quan) || 0) * (Number(price) || 0)).toFixed(2)}</h2>
        </div>
      </Flex>
      <div className="flex justify-between">
        <div className="w-29 h-10 rounded-4 border mt-5">
          <h3>Return To Shop</h3>
        </div>
        <div className="w-29 h-10 rounded-4 border mt-5 justify-center items-center ">
          <h3>Update Cart</h3>
        </div>
      </div>
      ...
      <div className="w-59 h-40 border-1 ml-184 absolute top-99">
        ...
        <div>
          <div className="bg-primary flex justify-between items-center text-white w-40 h-10">
